...
docker compose -f deploy/docker/local/cloud-mode/compose.yaml up -d
...
published. After login, use the Agent-Backed or Agentless Remote Snapshot workflow described in [Local Cloud Stack](../../../deploy/docker/local/cloud-mode/README.md).

## Local OAuth2Proxy And Keycloak Stack

For a full local login flow, use the Docker Compose stack in [Local Cloud Stack](../../../deploy/docker/local/cloud-mode/README.md). It starts
