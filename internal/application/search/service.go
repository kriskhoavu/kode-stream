...
type Service struct{ items itemReader }

func New(items itemReader) *Service { return &Service{items: items} }

func (s *Service) Search(query models.SearchQuery) ([]models.SearchResult, error) {
