...
**Verification:** `rtk go test ./...` plus `rtk docker compose -f docker/cloud-mode/compose.yaml config`
...
**Verification:** `rtk docker compose -f docker/cloud-mode/compose.yaml up -d --build` plus health and redirect smoke.
