...
|---------------------|---------------------------------------------------------------------------|-----------------------------------------------|
| `datadir` (default) | `./runbooks/docker/local-mode/run.sh`                                     | YAML/JSONL under the named Docker volume      |
| `database`          | `KODE_STREAM_STORAGE_OPTION=database ./runbooks/docker/local-mode/run.sh` | SQLite database under the named Docker volume |
...
```bash
KODE_STREAM_LOCAL_WORKSPACE=/absolute/path/to/repository ./runbooks/docker/local-mode/run.sh
```
...
```bash
docker compose -f runbooks/docker/local-mode/compose.yaml down
docker compose -f runbooks/docker/local-mode/compose.yaml down -v
```
