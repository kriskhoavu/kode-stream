...
export function E2EQualityPanel({ workspaceId, runbooks = [], diagnostic, onRefresh, variant = 'standalone' }: { workspaceId: string; runbooks?: E2ERunbook[]; diagnostic?: string; onRefresh?: () => void; variant?: 'standalone' | 'nested' }) {
