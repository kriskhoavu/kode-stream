...
> **Branch UI follow-up:** [PM-038](../PM-038/README.md) removes `BranchSnapshotPicker` from operational Workstream
> and item pages. Those pages now show the current checkout, while a dedicated read-only route owns non-checkout review.
