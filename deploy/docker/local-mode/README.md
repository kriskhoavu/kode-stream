...
|---------------------|---------------------------------------------------------------------------|-----------------------------------------------|
| `datadir` (default) | `./deploy/docker/local-mode/run.sh`                                     | YAML/JSONL under the named Docker volume      |
| `database`          | `KODE_STREAM_STORAGE_OPTION=database ./deploy/docker/local-mode/run.sh` | SQLite database under the named Docker volume |
...
```bash
KODE_STREAM_LOCAL_WORKSPACE=/absolute/path/to/repository ./deploy/docker/local-mode/run.sh
```
...
```bash
docker compose -f deploy/docker/local-mode/compose.yaml down
docker compose -f deploy/docker/local-mode/compose.yaml down -v
```
