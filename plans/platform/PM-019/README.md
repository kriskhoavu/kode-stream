# PM-019: Read-Only Jira Integration

PM-019 connects a registered workspace to Jira Cloud or Jira Server/Data Center. Plan Manager matches an item's identifier to its Jira issue, presents normalized issue details in the item workspace, and provides guarded attachment access without writing to Jira.
...
Display a matching Jira ticket and safely access its attachments from an item without copying Jira data into Git.
