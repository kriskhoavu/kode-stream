...
func New(workspaces workspaceReader, items itemReader, git gitReader) *Service {
	return &Service{workspaces: workspaces, items: items, git: git, now: time.Now}
}

func (s *Service) Check(workspaceID string) (models.WorkspaceHealth, error) {
...
func (s *Service) pathCheck(workspace models.WorkspaceConfig) models.HealthCheck {
...
func (s *Service) sourcesCheck(workspace models.WorkspaceConfig) models.HealthCheck {
...
func (s *Service) gitCheck(workspace models.WorkspaceConfig) models.HealthCheck {
...
func (s *Service) branchCheck(workspace models.WorkspaceConfig) models.HealthCheck {
...
func (s *Service) permissionsCheck(workspace models.WorkspaceConfig) models.HealthCheck {
	info, err := os.Stat(workspace.Path)
	if err != nil {
...
func (s *Service) indexCheck(workspace models.WorkspaceConfig) models.HealthCheck {
