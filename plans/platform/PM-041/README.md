...
It also needs flat ground. `.main-content`'s two corner glows suit Neon and muddy the lattice, so the shell names
the active variant and the glows are dropped beneath it.
