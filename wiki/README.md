---
slug: platform-wiki-index
title: Platform Wiki
pageType: REFERENCE
roles: BA, DEVELOPER, TESTER, USER
topics: platform, wiki, documentation, index
summary: Durable platform concepts, workflows, references, and browser journeys.
sourceRef: wiki/README.md
sourceCount: 0
---

## Pages
<!-- chunkId: platform-wiki-index-pages -->
<!-- keywords: pages, platform, canvas, branch context -->

| Page                                        | Type      | Roles                       | sourceCount | Summary                                                               |
|---------------------------------------------|-----------|-----------------------------|-------------|-----------------------------------------------------------------------|
...
| [[platform-branch-review-checkout-journey]] | HOW_TO    | TESTER, DEVELOPER           | 1           | Browser validation for review, import, checkout, and synchronization. |
| [[platform-terminal-canvas-journey]]        | HOW_TO    | TESTER, DEVELOPER           | 1           | Provider-neutral Canvas browser validation journey.                   |
