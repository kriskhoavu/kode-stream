...
- [x] Add Overview and Integrations tabs, with collapsible General, Health, and Sources sections in Overview.
...
- [x] Keep detailed health checks in Overview, place scanning in the detail header, and retain a compact scan summary in the list.
...
- [x] Add bounded image zoom and pointer-drag panning controls and verify the existing sandboxed HTML preview.
